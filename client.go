...
// APIClient manages communication with the User Management API API v1.0
...
type APIClient struct {
	...
	PredictionSlipsAPI *PredictionSlipsAPIService

	PuzzleSheetsAPI *PuzzleSheetsAPIService
