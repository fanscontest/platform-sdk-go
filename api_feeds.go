...
func (r ApiGetIdentitiesByPiidFeedPersonalizedRequest) Execute() ([]DomainFeedItem, *http.Response, error) {
...
func (r ApiGetPublicFeedRequest) Execute() ([]DomainFeedItem, *http.Response, error) {
