...
// MessageResponse Simple {data: {message}} envelope used by a few action endpoints.
...
// SetData gets a reference to the given MessageResponseData and assigns it to the Data field.
